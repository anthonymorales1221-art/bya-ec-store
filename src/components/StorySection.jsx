...
export default function StorySection() {
  ...
  return (
    <section id="historia" className="bg-[var(--ba-warm-white)] px-5 py-24 sm:px-8 sm:py-32 lg:px-10">
      <div className="mx-auto grid max-w-[1240px] gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:gap-24">
        <div className="self-start lg:sticky lg:top-28">
          ...
          <div className="relative mt-10 aspect-[4/3] overflow-hidden rounded-[28px] bg-[var(--ba-navy)]">
        ...
        <div className="divide-y divide-[var(--ba-border)]">
          {STEPS.map((step, index) => (
            <article key={step.title} ref={(element) => { stepRefs.current[index] = element; }} data-index={index} className="flex min-h-[52vh] flex-col justify-center py-16 lg:min-h-[68vh]">
